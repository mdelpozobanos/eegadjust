...
setup(
    name='eegadjust',
    version=find_version('eegadjust/__init__.py'),
    description='ADJUST method for EEG artifact rejection',
    long_description=read('README.rst') + read('HISTORY.rst'),
    author='Marcos DelPozo-Banos',
    author_email='mdelpozobanos@gmail.com',
    url='https://github.com/mdelpozobanos/eegadjust',
    packages=[
        'eegadjust',
    ],
    package_dir={'eegadjust': 'eegadjust'},
